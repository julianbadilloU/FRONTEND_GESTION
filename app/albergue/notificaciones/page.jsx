    ...
    return (
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex items-center justify-center py-20">
          <Loader2 size={32} className="animate-spin text-[#5e924e]" />
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        {notificaciones.length > 0 && noLeidas > 0 && (
          <button
            ...
            className="flex items-center gap-2 text-sm font-medium text-[#5e924e] hover:text-[#3d6b30] transition-colors disabled:opacity-50"
          >
            <CheckCheck size={18} />
              ...
              >
                ...
                {isPendiente && (
                  <button
                    ...
                    className="shrink-0 p-2 text-gray-400 hover:text-[#5e924e] hover:bg-gray-50 rounded-lg transition-colors disabled:opacity-50"
