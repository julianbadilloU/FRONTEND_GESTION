    ...
    try {
      ...
      if (error.response) {
        ...
        if (status === 400) {
          ...
          setServerError("Cuenta suspendida o desactivada. Contacta al administrador.");
        } else if (status === 500) {
  ...
  return (
    ...
    >
      ...
      <div className="text-center space-y-4 w-full max-w-sm">
        <PawPrint className="mx-auto text-[#b4d2a6] rotate-[-5deg]" size={56} fill="currentColor" />
        <h2 className="font-bold text-[1.4rem] text-gray-900 tracking-tight">Inicia Sesión</h2>
        <p className="text-xs text-gray-500 font-medium leading-relaxed">Ingresa tus datos</p>
      </div>
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-center">
            <Link href="/recuperar-contrasena" className="text-[0.7rem] text-[#8ea482] font-medium hover:underline text-center">
